	...
	<Card dis-hover>
		...
		<div style="max-width:600px">
			<Form ref="base" :model="base" label-position="top" :rules="base">
				...
				<FormItem label="微信token" prop="wechat_token">
					<Input v-model="base.wechat_token" search enter-button="确    定" @on-search="cmtSave('wechat_token')"></Input>
				</FormItem>

				<FormItem label="微信appId" prop="wechat_appid">
					<Input v-model="base.wechat_appid" search enter-button="确    定" @on-search="cmtSave('wechat_appid')"></Input>
				</FormItem>

				<FormItem label="微信验证码" prop="wechat_secret">
					<Input v-model="base.wechat_secret" search enter-button="确    定" @on-search="cmtSave('wechat_secret')"></Input>
				</FormItem>

				<FormItem label="微信加密key" prop="wechat_aeskey">
					<Input v-model="base.wechat_aeskey" search enter-button="确    定" @on-search="cmtSave('wechat_aeskey')"></Input>
				</FormItem>
			</Form>
		</div>
